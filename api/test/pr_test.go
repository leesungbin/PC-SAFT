...
func Test_PR_ab(t *testing.T) {
	amix, bmix := NNN_ethane_nHexane_cyclohexane.PR_ab(Temperature, Composition_NNN)
...
func Test_PR_vol(t *testing.T) {
	Vvap, Vliq := NNN_ethane_nHexane_cyclohexane.PR_vol(Pressure, Temperature, Composition_NNN)
	// just for liq volume..!
